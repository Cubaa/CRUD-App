"use strict";
const deleteUserBtn = document.querySelector('div.delete_user button');
const deleteInput = document.querySelector('div.delete_user input');
...
const updateForm = document.querySelector('.manage_panel_form');
const updateBtn = document.querySelector('.update_user button');
const updateInputId = document.querySelector('[name=id]');
